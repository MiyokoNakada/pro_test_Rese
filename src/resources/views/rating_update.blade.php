...
<div class="rating-update">
    ...
    <div class="rating-update__inner">
        <form class="rating-update__form" action="/rating/edit" method="POST" enctype="multipart/form-data">
            ...
            <textarea class="rating__form_textarea" name="comment" rows="8" cols="50" id="comment" placeholder="カジュアルな夜のお出かけにおすすめのスポット">{{ old('comment', $rating->comment) }}</textarea>
